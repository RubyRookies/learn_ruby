...
describe "multiply" do
  it "multiplies 3 and 3" do
    multiply(3,3).should == 9
  end

  it "multiplies 3 and 0" do
    multiply(3,0).should == 0
  end

  it "multiplies several numbers" do
    multiply(3,2,1,4).should == 24
  end
...
describe "power" do
  ...
  it "raises 10 to the power of 1" do
    power(10, 1).should == 10
  end

  it "raises 10 to the power of 0" do
    power(10, 0).should == 1
  end
end
